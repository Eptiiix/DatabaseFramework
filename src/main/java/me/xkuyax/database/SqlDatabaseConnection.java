...
import lombok.*;
import me.eptiiix.general.database.exceptions.SqlRuntimeException;
import me.eptiiix.general.database.function.*;
import me.eptiiix.general.database.handler.ConnectionHandler;
import me.eptiiix.general.database.handlers.HikariConnectionHandler;
import me.eptiiix.general.database.model.FieldInformation;
import me.eptiiix.general.database.model.TableInformation;
...
public final class SqlDatabaseConnection {
  ...
  @Setter private Consumer<String> statementDebugger;
  ...
  public static SqlDatabaseConnection hikari(
    ...
    return new SqlDatabaseConnection(
        me.eptiiix.general.database.HikariDataSourceCreator.createSource(host, port, database, user, pass),
        host,
        user,
        pass,
        port,
